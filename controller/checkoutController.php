...
class checkoutController
{
    ...
    {
        $px[00]="01"; // Format Indicator, Obrigatório, valor fixo: 01
        ...
        $px[26][01]="eduardomax27@outlook.com"; //Chave do destinatário do pix, pode ser EVP, e-mail, CPF ou CNPJ.
        ...
        $px[59]="Eduardo Silva"; //Nome do beneficiário/recebedor. Máximo: 25 caracteres.
