    ...
    <div class="container w-50">
        <div class="row">
            <div class="col-lg">
                ...
                <input type="text" class="form-control" name="InsertName" id="InsertName" value="<?php echo $data[0]['name'] ?>" >
            </div>
            <div class="col-lg">
                <label for="">Seu Sobrenome <span style="color: red">*</span></label>
                <input type="text" class="form-control" name="InsertNickname" id="InsertNickname" value="<?php echo $data[0]['nickname'] ?>">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg">
                ...
                <input type="date" class="form-control" name="InsertBirthdate" id="InsertBirthdate" value="<?php echo $data[0]['birthDate'] ?>">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg">
                ...
                <input type="text" class="form-control" name="InsertPhone" id="InsertPhone" value="<?php echo $data[0]['phone'] ?>">

            </div>
            <div class="col-lg">
                <label for="">Seu estado/cidade <span style="color: red">*</span></label>
                <select class="form-control" name="InsertState" id="InsertState" value="<?php echo $data[0]['FKstate'] ?>">
                    <?php 
