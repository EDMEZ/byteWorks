...
<div class="container mt-5">
    <div class="row">
        <div class="col-12 col-sm-6">
            <img class="img-thumbnail product-image" src="<?php echo $productData[0]['imagePath'] ?>">
        </div>
        <div class="col-12 col-sm-6 product-details">
            <h1 class="product-title"><?php echo $productData[0]['title'] ?></h1>
            <h4 class="product-price">R$ <?php echo number_format($productData[0]['amount'], 2, ',', '.'); ?></h4>
